'use strict';
const CACHE='rubik-puzzle-pwa-v9';
const BASE=new URL('./',self.location.href);
const LOCAL=[
  './','./index.html','./styles.css?v=20260918-1','./features.css?v=20260918-1','./tetra-visuals.css?v=20260918-2',
  './tetra-core.js?v=20260919-1','./tetra-worker.js?v=20260919-1','./app.js?v=20260919-1','./release-fixes.js?v=20260919-1','./features.js?v=20260918-1','./tetra-visuals.js?v=20260918-2',
